		...
		<div className="navbar bg-base-200">
			<div className="navbar-start">
				<div className="dropdown">
					...
					<ul tabIndex={0} className="px-2 mt-3 shadow menu menu-compact dropdown-content bg-base-100 rounded-box w-52">
			...
			<div className="navbar-end">
				...
				<Link href='/login' >Login <ArrowForwardOutlinedIcon /> </Link>
			</div>
